...
##### 1. ? ?????????? ???? ? ??????? ??????? ?????? "??". 
? ??????????? SDK ??? ???? ?????? ???????.  https://github.com/VKCOM/vk-ios-sdk/issues/527

##### 2. ??????? ??????????? ?????????? ?????? ??????????.
? VKShareDialogControllerResult ??????? VKShareDialogControllerResultError. 
? VKShareDialogController ? completionHandler ??????? ?????? ??????????, ??????? ???????????? ???? result ????????? ???????? VKShareDialogControllerResultError.
```objective-c
